...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { cantidad: @producto.cantidad, descripcion: @producto.descripcion, id_producto: @producto.id_producto, nombre: @producto.nombre, precio: @producto.precio }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { cantidad: @producto.cantidad, descripcion: @producto.descripcion, id_producto: @producto.id_producto, nombre: @producto.nombre, precio: @producto.precio }
    assert_redirected_to producto_path(assigns(:producto))
  end
